...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'name of Artist is not empty' }),
    (0, class_validator_1.IsString)({ message: 'name of Artist is must be string' }),
...
__decorate([
    ...
    __metadata("design:type", String)
], ArtistDto.prototype, "walletAddress", void 0);
