...
const fs = require("fs");
class AbiConfig {
    static abiEvent = JSON.parse(fs.readFileSync('../common/abi/abi-event-manager.json', 'utf-8'));
    static ticketEvent = JSON.parse(fs.readFileSync('../common/abi/abi-sold-ticket-event-manager.json', 'utf-8'));
    static marketplaceEvent = JSON.parse(fs.readFileSync('../common/abi/abi-marketplace.json', 'utf-8'));
