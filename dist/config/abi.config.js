...
class AbiConfig {
    static abiEvent = JSON.parse(fs.readFileSync(path_1.default.join(currentDir, '../../common/abi/abi-event-manager.json'), 'utf-8'));
    static ticketEvent = JSON.parse(fs.readFileSync(path_1.default.join(currentDir, '../../common/abi/abi-ticket.json'), 'utf-8'));
    static marketplaceEvent = JSON.parse(fs.readFileSync(path_1.default.join(currentDir, '../../common/abi/abi-marketplace.json'), 'utf-8'));
